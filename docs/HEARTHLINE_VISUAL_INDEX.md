# Hearthline Visual Index

> **An image can preserve a visible choice. It cannot become the authority behind it.**
...
and scene material. The [artifact branch](../lore/artifacts/) keeps fictional
objects beside their lore, while plainly named `history-and-artifacts/` rooms
hold superseded visual studies. That topology is editorial presentation only:
it does not activate, adopt, deprecate, or migrate an operational component.
...
- `REFERENCE` — a current supplied visual anchor, still non-controlling.
...
| Identity | Exact repository file | Dimensions | SHA-256 | Status | Side | Narrative caption |
|---|---|---:|---|---|---|---|
| `HEARTHLINE/IMAGE-000001` | [Hearthline Gremlin Hunter reference sheet](../assets/characters/hearthline-gremlin-hunter-reference-sheet.png) | `1122 × 1402` | `c687dbc75f4209de4dad6c69e72b00221ad6b5cbbe5be2ba5037b075a7e8948b` | `REFERENCE` | Present | Gold, work-worn leather, green eyes, practical tools, cyan trace-light, and the delighted look of someone whose impossible problem has finally become interesting. |
| `OWL-000001/IMAGE-000001` | [Thulia fireside portrait study](../assets/characters/history-and-artifacts/thulia-fireside-portrait-study.png) | `1024 × 1536` | `f3aedaecdd63235f1e7485de6123aad5bf74780a5d778eef58ebbe84f6ff61ba` | `STUDY` | History | Thulia first arrives in firelight: tiny, exact, and already prepared to hold a misplaced paper personally responsible. |
| `OWL-000001/IMAGE-000002` | [Thulia naturalistic model-sheet study](../assets/characters/history-and-artifacts/thulia-naturalistic-model-sheet-study.png) | `1024 × 1536` | `09977aff8345ed682da6ead729ef0497dc8b7fdb822e78ac99b2443ee22620ca` | `STUDY` | History | A study of feather, wing, proportion, and Northlight color that taught the later cartoon form how an owl carries changing light. |
| `OWL-000001/IMAGE-000003` | [Thulia cartoon expression-sheet study](../assets/characters/history-and-artifacts/thulia-cartoon-expression-sheet-study.png) | `1024 × 1536` | `9e26ce5be35f6f375cbf583da441b3cff613bcd05283a936332c9d483c565dcb` | `STUDY` | History | Her round construction, crest-brow language, eye states, and speaking beak begin learning how to disagree politely and unmistakably. |
| `OWL-000001/IMAGE-000004` | [Thulia initial bilateral sheet](../assets/characters/history-and-artifacts/thulia-bilateral-sheet-initial.png) | `1024 × 1536` | `d5c90e5052918ee5056852fd9d6113eff5bef951602e893de67b71e733da14fe` | `SUPERSEDED_STUDY` | History | The first four-view pass proves that left and right can disagree even when both are labeled; that honest mistake begins the correction trail. |
| `OWL-000001/IMAGE-000005` | [Thulia front-correction pass](../assets/characters/history-and-artifacts/thulia-bilateral-sheet-front-correction.png) | `1024 × 1536` | `774c68ad2901eac668288e21a785e8860d6e11e96205073af6df2951739f28ba` | `SUPERSEDED_STUDY` | History | The front view finds the right leg while the back still loses it—a useful halfway truth, kept visible instead of dressed up as completion. |
| `OWL-000001/IMAGE-000006` | [Thulia bilateral animation reference](../assets/characters/thulia-bilateral-animation-reference-sheet.png) | `1024 × 1536` | `89a1c020bdb523150d0271a702186bbeed967db4822063b3cc0b1e4d2e97bae5` | `CURRENT_VISUAL_REFERENCE` | Present | Right-leg copper band, asymmetric shoulder markings, changing Northlight colors, speaking beak, and crest-brow expressions finally share one usable map. |
| `OWL-000001/IMAGE-000007` | [Hearthline and Thulia at the trace workbench](../assets/scenes/hearthline-and-thulia-at-the-trace-workbench.png) | `1536 × 1024` | `0919ec8bf0a0577f668a013b041be1b18a15e562bf9cc6d4c0c97a3c6775d602` | `SCENE` | Present | Hearthline reaches toward a living map while Thulia returns a numbered trace; one finds the next way out, the other keeps the way home legible. |
| `HEARTHLINE/IMAGE-000002` | [Prismatic twin-spiral Rainbow Shell source](../lore/artifacts/prismatic-twin-spiral-rainbow-shell-source.png) | `1254 × 1254` | `2ead5044ca62f2920782cb11425d476199a53fc58ce080e75b454c1ae13d3bf1` | `SOURCE_ARTIFACT` | Present | Two mirrored spirals share a gold circumference and preserve a dark opening where the unknown still has room to enter. |
| `HEARTHLINE/IMAGE-000003` | [Hearthline and Thulia with the first loupe](../assets/scenes/hearthline-and-thulia-with-the-first-loupe.png) | `1536 × 1024` | `acf4c2b08732aeeac1f412a5dbcb90e0620b1d5ce6745f77c437538cb334414a` | `SCENE` | Present | One careful look, one second witness, and a warm bench: the ordinary beginning from which much larger instruments will eventually grow. |
| `HEARTHLINE/IMAGE-000004` | [Workshop standoff before the Spark Mode tell](../assets/scenes/history-and-artifacts/hearthline-workshop-standoff-before-spark-mode.png) | `1536 × 1024` | `d0283da79341c87d2b63b75dc4b37a52abf46e2e94dceeb061e44baed7604f95` | `SUPERSEDED_SCENE` | History | The first dangerous gremlin already meets the right delighted expression, but Hearthline's still-dark pupils predate the settled Spark Mode sign. |
| `HEARTHLINE/IMAGE-000005` | [Spark Mode workshop standoff](../assets/scenes/hearthline-spark-mode-workshop-standoff.png) | `1536 × 1024` | `2c4390fdf54ca89a54eb1a1fd43e95171ec33a796481b6f50250733948318893` | `SCENE` | Present | A dangerous gremlin has chosen the wrong workshop, and Hearthline's pale pearlescent pupils say she is ready to meet the problem at full brightness. |
...
`OWL-000001/IMAGE-000001` through `IMAGE-000005` are intentionally historical. Early images explore mood, realism, cartoon expression, and laterality; several place or omit the copper band inconsistently. `OWL-000001/IMAGE-000006` is the current visual aid: front band on viewer-left/anatomical right, right profile near leg banded, back band on viewer-right/anatomical right, and left profile near leg unbanded. Even there, `OWL-000001/SHEET-000002` controls exact construction, including her six anatomical Northlight fields: two crest plumes, two broken-gorget halves, and two shoulder commas.

`OWL-000001/IMAGE-000007` is a warm working scene, not an orthographic sheet. Its pages, marks, drawers, numbers, and gestures are illustrative marks rather than records, commands, credentials, receipts, or approvals.

### Hearthline's Spark Mode

`HEARTHLINE/IMAGE-000004` is preserved because it caught Hearthline's excitement before the visible mode distinction was chosen. `HEARTHLINE/IMAGE-000005` adds the settled fictional tell: normally black pupils become soft pearlescent white with a faint green-cyan cast, still pupil-shaped and blending into the green iris rather than turning the entire eye blank white. Her surrounding glow may vary. The pupil change is character lore presentation only; it does not describe a model mode, executable state, trigger, or protocol.
...
Christopher D. Pang designates the visual assets listed in this index as covered by the repository's [Creative Commons Attribution 4.0 International License](../LICENSE) to the extent copyright or similar rights subsist in them and he holds the rights necessary to license them.

AI-assisted generation status does not by itself settle whether every visual element is copyrightable. This notice licenses only rights the licensor can grant. Third-party material, platform terms, names, and marks retain their own treatment. The Hearthline name and identifying marks are not licensed as trademarks; see [TRADEMARKS.md](../TRADEMARKS.md).

Attribution should identify Christopher D. Pang, the image identity, this repository, and any material changes. An adaptation does not become official, controlling, endorsed, or canonical merely because it preserves an image identity or resembles a listed file.

## No-authority and no-activation boundary
...
- approve carry, load a Bridge Gloss, or certify a receipt;
- turn depicted writing, numbers, colors, gestures, or objects into machine-readable controls; or
- make an image, derivative, animation, or fictional artifact an official Hearthline release.

The characters and their artifacts are presentation and lore. Written, bounded, separately adopted records retain control.
